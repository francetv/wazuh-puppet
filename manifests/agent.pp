...
class wazuh::agent (
  ...
  String $manage_client_keys                           = $wazuh::params_agent::manage_client_keys,
  ...
  Stdlib::AbsolutePath $wazuh_manager_root_ca_pem      = $wazuh::params_agent::wazuh_manager_root_ca_pem,
