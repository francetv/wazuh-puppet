...
class wazuh::agent (
  ...
  String $agent_package_revision                                 = $wazuh::params_agent::agent_package_revision,
  ...
  String $agent_service_ensure                                   = $wazuh::params_agent::agent_service_ensure,
  String $agent_msi_download_location                            = $wazuh::params_agent::agent_msi_download_location,

  # Authd registration options
  Optional[String] $manage_client_keys                           = $wazuh::params_agent::manage_client_keys,
  Optional[String] $agent_name                                   = $wazuh::params_agent::agent_name,
  Optional[String] $agent_group                                  = $wazuh::params_agent::agent_group,
  Optional[String] $agent_address                                = $wazuh::params_agent::agent_address,
  ...
  Optional[String] $agent_auth_password                          = $wazuh::params_agent::agent_auth_password,
  Optional[Stdlib::AbsolutePath] $wazuh_manager_root_ca_pem      = $wazuh::params_agent::wazuh_manager_root_ca_pem,
